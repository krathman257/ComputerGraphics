...
public:
    ...
    CustomObj(std::vector<std::vector<float>> v, std::vector<glm::vec3> t, bool isFlat) {
        for (int i = 0; i < t.size(); i++) {
            int ind1 = int(t[i][0])-1;
            int ind2 = int(t[i][1])-1;
            int ind3 = int(t[i][2])-1;
            ...
            add_vertex(coords, v[ind1][0], v[ind1][1], v[ind1][2], v[ind1][3], v[ind1][4], v[ind1][5], normal1);
            add_vertex(coords, v[ind2][0], v[ind2][1], v[ind2][2], v[ind2][3], v[ind2][4], v[ind2][5], normal2);
            add_vertex(coords, v[ind3][0], v[ind3][1], v[ind3][2], v[ind3][3], v[ind3][4], v[ind3][5], normal3);
        }
    }
};
